...
\end{problem}
\begin{solution}
Il \textit{Common Language Runtime} (CLR) viene utilizzato in .NET come ambiente di esecuzione in runtime delle applicazioni.
\newline
...
\end{problem}
\begin{solution}
La capacità di sopravvivenza del sistema è una proprietà di quest'ultimo e indica la capacità di effettuare servizi agli utenti che ne hanno il permesso, qualora il sistema sia sotto attacco o con componenti danneggiate.
\newline
