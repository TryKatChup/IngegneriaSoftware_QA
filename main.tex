...
\begin{itemize}
	\item Si consideri una classe \texttt{BigliettoConcerto} e una classe \texttt{GestoreVenditaBiglietti} che si occupa della vendita di \texttt{BigliettoConcerto}
	\item Si considerino le classi \texttt{BigliettoNormale} e \texttt{BigliettoVIP}, che dipendono da \texttt{BigliettoConcerto}
	\item \texttt{BigliettoConcerto} deve essere astratto, in quanto sia \texttt{BigliettoNormale} che \texttt{BigliettoVIP} dipendono da esso.
\end{itemize}
\end{solution}
