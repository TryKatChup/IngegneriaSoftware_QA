...
\item Si vuole dare la possibilità di aggiungere ulteriori ingredienti in ciascun tè; pertanto si dichiara l' interfaccia ITeaExtra, che rappresenta il \texttt{Decorator};
\item Si realizzano le classi concrete che implementano l'interfaccia \texttt{ITeaExtra}, come \texttt{TeaWithMilk},
\\
\texttt{TeaWithHoney}, \texttt{TeaWithIce}
\end{itemize}
\end{solution}
